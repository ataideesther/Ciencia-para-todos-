...
<head>
    ...
    <title>Atividade de Introdução a Química</title>
    <link rel="stylesheet" href="css/atividadeintquimica.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="quiz-container">
            ...
            <div class="button-container">
                ...
                <button class="btn btn-secondary" id="next-btn">Próxima</button>
                <button class="btn btn-primary" id="finish-btn" style="display: none;">Finalizar</button>
            </div>
        </div>
    </div>
    ...
    <script src="js/atividadeintquimica.js"></script>
</body>
