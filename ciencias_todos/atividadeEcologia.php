...
<head>
    ...
    <title>Atividade de Ecologia</title>
    <link rel="stylesheet" href="css/atividadeecologia.css">
...
<body>
    ...
    <script>
        ...
        const idAluno = <?php echo isset($_SESSION['id']) ? $_SESSION['id'] : 0; ?>;
    </script>
    <script src="js/atividadeecologia.js"></script>
</body>
