document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchQuestions() {
        ...
        fetch('get_questions_citologia.php')
            .then(response => {
                if (!response.ok) {
    ...
    function showResults() {
        ...
        fetch('salvar_respostas_citologia.php', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                window.location.href = `resultados_citologia.php?pontuacao=${data.pontuacao}&total=${questions.length}`;
            } else {
