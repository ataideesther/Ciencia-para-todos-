...
if (!isset($_SESSION['id']) || !isset($_SESSION['tipo']) || $_SESSION['tipo'] !== 'aluno') {
    header('Location: alunoLogin.php');
    exit();
}

// Se chegou aqui, o usuário está logado e é um aluno
...
<head>
    ...
    <title>Atividade de Ligações Químicas</title>
    <link rel="stylesheet" href="css/atividadeligacoesquimicas.css">
...
<body>
    ...
    <script src="js/atividadeligacoesquimicas.js"></script>
</body>
